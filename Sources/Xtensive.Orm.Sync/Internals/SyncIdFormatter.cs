...
namespace Xtensive.Orm.Sync
{
  internal static class SyncIdFormatter
  {
    ...
    public static SyncId GetLowerBound(SyncId replicaId, int hierarchyId)
    {
      return GetSyncId(replicaId, hierarchyId, 0);
    }

    public static SyncId GetUpperBound(SyncId replicaId, int hierarchyId)
    {
      return GetSyncId(replicaId, hierarchyId, -1);
    }
