call .nuget\NuGet.exe pack Xtensive.Orm.BulkOperations\Xtensive.Orm.BulkOperations.csproj -o _Build\NuGet
call .nuget\NuGet.exe pack Xtensive.Orm.Localization\Xtensive.Orm.Localization.csproj -o _Build\NuGet
